...
-- 投稿、いいね、コメント、保存機能
--
-- ⚠️ 注意: このスクリプトは既存のpostsテーブルを削除します
-- 開発環境専用です。本番環境では使用しないでください。
...
DROP TRIGGER IF EXISTS trigger_update_post_saves_count ON public.saves;
